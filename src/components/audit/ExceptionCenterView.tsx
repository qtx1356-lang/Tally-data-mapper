...
export const ExceptionCenterView: React.FC = () => {
  ...
  const exceptions: AuditException[] = [
    { id: 'EX-1001', risk: 'HIGH', riskScore: 88, date: '2024-05-12', voucherNo: 'PUR/00124', voucherType: 'Purchase', ledger: 'Cash', party: 'Modern Electronics Ltd', amount: 45000, exceptionType: 'Cash Limit Violation', reason: 'Single cash payment exceeding ₹10,000 statutory limit.', status: 'Pending' },
    { id: 'EX-1002', risk: 'MEDIUM', riskScore: 62, date: '2024-05-13', voucherNo: 'PAY/00542', voucherType: 'Payment', ledger: 'ICICI Bank', party: 'Consultancy Fees', amount: 15000, exceptionType: 'Backdated Entry', reason: 'Voucher date is 45 days prior to entry date.', status: 'Reviewed' },
    { id: 'EX-1003', risk: 'HIGH', riskScore: 92, date: '2024-05-14', voucherNo: 'SAL/00871', voucherType: 'Sales', ledger: 'Sales A/c', party: 'Walk-in Customer', amount: 125000, exceptionType: 'Negative Inventory', reason: 'Sale recorded while stock was zero, creating negative balance.', status: 'Pending' },
    { id: 'EX-1004', risk: 'LOW', riskScore: 24, date: '2024-05-15', voucherNo: 'EXP/00213', voucherType: 'Journal', ledger: 'Conveyance', party: 'Staff Welfare', amount: 1200, exceptionType: 'Round Sum Pattern', reason: 'Repeated round sum entries for subjective expenses.', status: 'Finding' },
    { id: 'EX-1005', risk: 'MEDIUM', riskScore: 55, date: '2024-05-16', voucherNo: 'PUR/00128', voucherType: 'Purchase', ledger: 'Input GST', party: 'Global Trading Co', amount: 84200, exceptionType: 'Tax Rate Mismatch', reason: 'Calculated GST (18%) differs from voucher tax entry.', status: 'Pending' },
  ];
